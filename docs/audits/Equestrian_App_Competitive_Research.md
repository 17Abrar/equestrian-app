# Equestrian App — Competitive Research

## The Verdict

Nobody is doing what you're building. Not fully. The market has fragments — booking here, stable management there — but nobody has combined smart horse-rider matching, feed tracking, fatigue management, and club booking into one platform. Especially not in the GCC.
...
- No club-side dashboard
- Basically a "ClassPass for riding lessons"
...
- Popular with endurance/trail riders, not clubs
...
- No booking system, no rider matching, no feed tracking
- Desktop-heavy, not mobile-first
...
- No stable management features
- Threat level: LOW-MEDIUM — closest to booking piece, but dumb booking only
...
- Dubai Equestrian Club, Al Habtoor Polo — all manual booking via phone/WhatsApp
...
- GCC clubs have money and will pay for premium SaaS

---

## Pricing Benchmarks (What Competitors Charge)

- StableSecretary: $25-50/month
- BarnManager: $30-75/month
- Equilab Pro: $8/month (rider individual)
- Riding Club Pro: £40-80/month
...
- Premium rider features (analytics, progress tracking): AED 30-50/month
- Transaction fee on bookings: 3-5% per booking

---

## Features Nobody Has Combined (Your Moat)

1. Smart horse-rider matching by skill level — NOBODY does this
2. Horse fatigue/usage tracking with automatic cooldowns — NOBODY does this
3. Feed inventory tracking with restock alerts — BarnManager does basic version, but not connected to booking
4. Club-side dashboard + rider-facing booking in ONE platform — NOBODY does this
5. Arabic/English bilingual — NOBODY in equestrian tech
6. GCC-first design (understanding of local club culture) — NOBODY

---

## Risk Factors

- Generic booking platforms (Fresha, Booksy) could add equestrian vertical — but unlikely, too niche
- A big tech company could build this — but equestrian is too small for them to care
- Adoption friction: convincing traditional club managers to use tech
...
This idea has legs. The market is fragmented, nobody owns the full stack, and the GCC is wide open. The smart matching + fatigue tracking combo is genuinely novel. If you build this right and price it right, you're looking at a real SaaS business — not a side project.

Next step: lock down the feature spec and start wireframing.
