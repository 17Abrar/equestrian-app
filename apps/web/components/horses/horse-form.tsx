  ...
  const form = useForm<CreateHorseFormValues, unknown, CreateHorseInput>({
    ...
    defaultValues: horse
      ? {
          ...
          status: horse.status as CreateHorseFormValues['status'],
          skillLevel: horse.skillLevel as CreateHorseFormValues['skillLevel'],
          ...
          saleStatus: horse.saleStatus as CreateHorseFormValues['saleStatus'],
