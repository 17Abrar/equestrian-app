      ...
      <Body style={styles.body}>
        <Container style={styles.container}>
          ...
          <Text style={styles.text}>
            We wanted to let you know that {clubName} wasn&apos;t able to accept
            {' '}{horseName}&apos;s registration at this time.
          </Text>
          ...
          <Text style={styles.text}>
            If you have questions or think this was a mistake, please reach
            out to {clubName} directly. You&apos;re welcome to submit a new
            registration once any issues are resolved.
          </Text>
...
const styles = {
  ...
  label: { fontSize: '11px', color: '#92400e', textTransform: 'uppercase' as const, letterSpacing: '0.05em', margin: '0 0 6px', fontWeight: '600' as const },
  reason: { fontSize: '14px', color: '#78350f', lineHeight: '22px', margin: '0', whiteSpace: 'pre-wrap' as const },
