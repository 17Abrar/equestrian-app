...
export const horseHealthRecords = pgTable(
...
export const horseMedications = pgTable(
  'horse_medications',
  {
    id: uuid('id').primaryKey().defaultRandom(),
    clubId: uuid('club_id')
...
export const horseMedicationLogs = pgTable(
...
export const horseFeedingPlans = pgTable(
  'horse_feeding_plans',
  {
    id: uuid('id').primaryKey().defaultRandom(),
    clubId: uuid('club_id')
...
export const horseFeedTracker = pgTable(
  'horse_feed_tracker',
  {
    id: uuid('id').primaryKey().defaultRandom(),
    clubId: uuid('club_id')
...
export const horseExerciseSchedules = pgTable(
...
export const horseCareReminderSends = pgTable(
  ...
  (table) => [
    ...
    index('idx_horse_care_reminder_sends_club').on(table.clubId, sql`${table.sentAt} DESC`),
